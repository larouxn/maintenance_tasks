...
ActiveRecord::Schema.define(version: 2025_07_25_000000) do
  ...
  create_table "maintenance_tasks_runs", force: :cascade do |t|
    ...
    t.text "metadata"
    # TODO: consider renaming parent_run_id to concurrent_parent_run_id
    t.bigint "parent_run_id"
    t.integer "concurrency_level"
    # TODO: consider renaming start_cursor to concurrent_start_cursor
    # and end_cursor to concurrent_end_cursor for clarity.
    t.bigint "start_cursor"
    t.bigint "end_cursor"
